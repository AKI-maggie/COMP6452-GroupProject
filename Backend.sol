...
contract Backend is usingProvable{
    ...
    function receiptAuthenticate(string memory receiptNo, string memory restName, address sender) payable public
        enoughPrice notEmpty(receiptNo) notEmpty(restName)  {
